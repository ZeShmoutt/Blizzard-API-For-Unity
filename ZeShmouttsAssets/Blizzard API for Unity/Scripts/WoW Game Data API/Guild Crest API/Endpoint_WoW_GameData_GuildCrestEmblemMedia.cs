...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			/// <summary>
			/// Coroutine that retrieves the medias of a WoW guild crest emblem.
			/// </summary>
			...
			/// <returns></returns>
			public static IEnumerator GetGuildCrestEmblemMedia(int emblemId, Action<WowGuildCrestEmblemMedia_JSON> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = BattleNetRegion.UnitedStates)
			{
