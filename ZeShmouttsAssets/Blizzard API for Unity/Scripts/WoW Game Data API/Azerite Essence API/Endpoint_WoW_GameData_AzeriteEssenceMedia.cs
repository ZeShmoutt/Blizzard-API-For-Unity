...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			/// <summary>
			/// Coroutine that retrieves the medias of a WoW azerite essence.
			/// </summary>
			...
			/// <returns></returns>
			public static IEnumerator GetAzeriteEssenceMedia(int azeriteEssenceId, Action<WowAzeriteEssenceMedia_JSON> action_Result, Action<string> action_LastModified = null, BattleNetRegion region = BattleNetRegion.UnitedStates)
			{
