...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			/// <summary>
			/// Coroutine that retrieves a WoW quest by ID.
			/// </summary>
			...
			/// <returns></returns>
			public static IEnumerator GetQuest(int questId, Action<WowQuest_JSON> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DefaultRegion)
			{
				string path = string.Format("/data/wow/quest/{0}", questId);
...
{
	/// <summary>
	/// JSON structure for World of Warcraft quest.
	/// </summary>
	[Serializable]
	public class WowQuest_JSON : Object_Json
	{
