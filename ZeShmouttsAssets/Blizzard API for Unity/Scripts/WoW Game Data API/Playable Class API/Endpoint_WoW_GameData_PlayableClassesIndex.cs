...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetPlayableClassesIndex(Action<WowPlayableClassesIndex_JSON> action_Result, Action<string> action_LastModified = null, BattleNetRegion region = BattleNetRegion.UnitedStates)
			{
