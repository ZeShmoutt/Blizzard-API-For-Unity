...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			/// <summary>
			/// Coroutine that retrieves the medias of a WoW playable class.
			/// </summary>
			...
			/// <returns></returns>
			public static IEnumerator GetPlayableClassMedia(int playableClassId, Action<WowPlayableClassMedia_JSON> action_Result, Action<string> action_LastModified = null, BattleNetRegion region = BattleNetRegion.UnitedStates)
			{
