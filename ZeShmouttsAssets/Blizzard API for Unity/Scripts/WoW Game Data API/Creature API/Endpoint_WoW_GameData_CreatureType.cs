...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			/// <summary>
			/// Coroutine that retrieves a WoW creature type.
			/// </summary>
			...
			/// <returns></returns>
			public static IEnumerator GetCreatureType(int creatureTypeId, Action<WowCreatureType_JSON> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = BattleNetRegion.UnitedStates)
			{
