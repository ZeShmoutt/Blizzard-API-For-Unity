...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetCreatureDisplayMedia(int creatureDisplayId, Action<WowCreatureDisplayMedia_JSON> action_Result, Action<string> action_LastModified = null, BattleNetRegion region = BattleNetRegion.UnitedStates)
			{
