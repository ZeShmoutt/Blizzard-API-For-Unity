...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			/// <summary>
			/// Coroutine that retrieves the medias of a WoW spell.
			/// </summary>
			...
			/// <returns></returns>
			public static IEnumerator GetSpellMedia(int spellId, Action<WowSpellMedia_JSON> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = BattleNetRegion.UnitedStates)
			{
