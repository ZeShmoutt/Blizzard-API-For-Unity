...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			/// <summary>
			/// Coroutine that retrieves the medias of a WoW item.
			/// </summary>
			...
			/// <returns></returns>
			public static IEnumerator GetItemMedia(int itemId, Action<WowItemMedia_JSON> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = BattleNetRegion.UnitedStates)
			{
