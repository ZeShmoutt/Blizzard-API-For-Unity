...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			/// <summary>
			/// Coroutine that retrieves a WoW guild's achievements.
			/// </summary>
			...
			/// <returns></returns>
			public static IEnumerator GetGuildAchievements(BattleNetRegion region, string realmSlug, string nameSlug, Action<WowGuildAchievements_JSON> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null)
			{
				string path = string.Format("/data/wow/guild/{0}/{1}/achievements", realmSlug, nameSlug);
...
{
	/// <summary>
	/// JSON structure for a World of Warcraft guild's achievements.
	/// </summary>
	[Serializable]
	public class WowGuildAchievements_JSON : Object_Json
	{
