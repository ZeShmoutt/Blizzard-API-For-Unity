...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			/// <summary>
			/// Coroutine that retrieves a summary of a WoW character's titles.
			/// </summary>
			...
			/// <returns></returns>
			public static IEnumerator GetCharacterTitlesSummary(BattleNetRegion region, string realmSlug, string characterName, Action<WowCharacterTitlesSummary_JSON> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null)
			{
				string path = string.Concat(characterBasePath, realmSlug, "/", characterName, "/titles");
...
{
	/// <summary>
	/// JSON structure for a summary of a World of Warcraft character's titles.
	/// </summary>
	[Serializable]
	public class WowCharacterTitlesSummary_JSON : Object_Json
	{
