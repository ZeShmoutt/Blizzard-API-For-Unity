...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowProfile
		{
			...
			/// <returns></returns>
			public static IEnumerator GetCharacterProfileSummary(BattleNetRegion region, string realmSlug, string characterName, Action<WowCharacterProfileSummary_JSON> action_Result, Action<string> action_LastModified = null)
			{
