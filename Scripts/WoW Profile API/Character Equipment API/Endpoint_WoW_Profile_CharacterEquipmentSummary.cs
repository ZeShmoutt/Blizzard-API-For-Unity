...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			internal const string apiPath_CharacterEquipmentSummary = "/equipment";
			...
			{
				string path = FormatWowCharacterEndpointPath(realmSlug, characterName) + apiPath_CharacterEquipmentSummary;
