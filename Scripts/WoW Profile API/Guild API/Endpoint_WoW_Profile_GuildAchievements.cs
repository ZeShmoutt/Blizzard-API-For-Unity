...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			internal const string API_PATH_GUILDACHIEVEMENTS = "/achievements";
			...
			/// <returns></returns>
			public static IEnumerator GetGuildAchievements(BattleNetRegion region, string realmSlug, string nameSlug, Action<Json_Wow_GuildAchievements> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null)
			{
				string path = FormatWowGuildEndpointPath(realmSlug, nameSlug) + API_PATH_GUILDACHIEVEMENTS;
			...
			/// <param name="action_OnError">Action to execute when the request returns an error.</param>
			/// <returns></returns>
			public static IEnumerator GetGuildAchievementsRaw(BattleNetRegion region, string realmSlug, string nameSlug, Action<string> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null)
			{
				string path = FormatWowGuildEndpointPath(realmSlug, nameSlug) + API_PATH_GUILDACHIEVEMENTS;
				yield return SendRequest(region, NAMESPACE_PROFILE, path, action_Result, ifModifiedSince, action_LastModified, action_OnError);
			}
