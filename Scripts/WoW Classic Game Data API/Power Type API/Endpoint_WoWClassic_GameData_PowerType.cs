...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowClassicGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetPowerType(int powerTypeId, Action<Json_WowClassic_PowerType> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DEFAULT_REGION)
			{
