...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowClassicGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetItemSubclass(int itemClassId, int itemSubclassId, Action<Json_WowClassic_ItemSubclass> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DEFAULT_REGION)
			{
...
{
	/// <summary>
	/// JSON structure for World of Warcraft (Classic), representing an item subclass.
	/// </summary>
	[Serializable]
	public class Json_WowClassic_ItemSubclass : Object_JSON
	{
		// {{JSON_START}}
