...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowClassicGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetItem(int itemId, Action<Json_WowClassic_Item> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
...
{
	/// <summary>
	/// JSON structure for World of Warcraft (Classic), representing an item.
	/// </summary>
	[Serializable]
	public class Json_WowClassic_Item : Object_JSON
	{
		// {{JSON_START}}
