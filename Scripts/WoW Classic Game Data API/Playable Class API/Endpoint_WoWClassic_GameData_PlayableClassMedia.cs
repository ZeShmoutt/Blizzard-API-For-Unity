...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowClassicGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetPlayableClassMedia(int playableClassId, Action<Json_WowClassic_PlayableClassMedia> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DefaultRegion)
			{
