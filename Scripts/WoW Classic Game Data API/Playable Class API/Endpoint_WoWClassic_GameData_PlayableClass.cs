...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowClassicGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetPlayableClass(int classId, Action<Json_WowClassic_PlayableClass> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
