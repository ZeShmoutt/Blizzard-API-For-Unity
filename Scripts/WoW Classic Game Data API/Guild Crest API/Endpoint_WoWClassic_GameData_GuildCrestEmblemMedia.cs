...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowClassicGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetGuildCrestEmblemMedia(int emblemId, Action<Json_WowClassic_GuildCrestEmblemMedia> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DEFAULT_REGION)
			{
			...
			/// <param name="region">The region of the data to retrieve.</param>
			/// <returns></returns>
			public static IEnumerator GetGuildCrestEmblemMediaRaw(int emblemId, Action<string> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DEFAULT_REGION)
			{
				string path = string.Format(apiPath_GuildCrestEmblemMedia, emblemId);
				yield return SendRequest(region, NAMESPACE_CLASSIC_STATIC, path, action_Result, ifModifiedSince, action_LastModified);
			}
...
{
	/// <summary>
	/// JSON structure for World of Warcraft (Classic), representing media for a guild crest emblem.
	/// </summary>
	[Serializable]
	public class Json_WowClassic_GuildCrestEmblemMedia : Object_JSON
	{
		// {{JSON_START}}
