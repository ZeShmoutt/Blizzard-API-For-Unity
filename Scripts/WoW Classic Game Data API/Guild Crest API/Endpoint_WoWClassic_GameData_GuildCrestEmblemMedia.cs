...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			internal const string API_PATH_GUILDCRESTEMBLEMMEDIA = BASEPATH_WOW_GAMEDATA + "/media/guild-crest/emblem/{0}";
			...
			/// <returns></returns>
			public static IEnumerator GetGuildCrestEmblemMedia(int emblemId, Action<Json_WowClassic_GuildCrestEmblemMedia> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
