...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			internal const string API_PATH_CREATUREFAMILY = BASEPATH_WOW_GAMEDATA + "/creature-family/{0}";
			...
			/// <returns></returns>
			public static IEnumerator GetCreatureFamily(int creatureFamilyId, Action<Json_WowClassic_CreatureFamily> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
				string path = string.Format(API_PATH_CREATUREFAMILY, creatureFamilyId);
			...
			/// <param name="region">The region of the data to retrieve.</param>
			/// <returns></returns>
			public static IEnumerator GetCreatureFamilyRaw(int creatureFamilyId, Action<string> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
				string path = string.Format(API_PATH_CREATUREFAMILY, creatureFamilyId);
				yield return SendRequest(region, NAMESPACE_CLASSIC_STATIC, path, action_Result, ifModifiedSince, action_LastModified, action_OnError);
			}
