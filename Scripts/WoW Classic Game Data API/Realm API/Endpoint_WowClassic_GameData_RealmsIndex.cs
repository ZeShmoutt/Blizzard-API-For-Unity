...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			internal const string API_PATH_REALMSINDEX = BASEPATH_WOW_GAMEDATA + "/realm/index";
			...
			/// <returns></returns>
			public static IEnumerator GetRealmsIndex(Action<Json_WowClassic_RealmsIndex> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
...
{
	/// <summary>
	/// JSON structure for World of Warcraft (Classic), representing an index of realms.
	/// </summary>
	[Serializable]
	public class Json_WowClassic_RealmsIndex : Object_JSON
	{
		// {{JSON_START}}
