...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class D3GameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetSeasonLeaderboard(int seasonId, string leaderboard, Action<Json_D3_SeasonLeaderboard> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DEFAULT_REGION)
			{
			...
			/// <param name="region">The region of the data to retrieve.</param>
			/// <returns></returns>
			public static IEnumerator GetSeasonLeaderboardRaw(int seasonId, string leaderboard, Action<string> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DEFAULT_REGION)
			{
				string path = string.Format(apiPath_SeasonLeaderboard, seasonId, leaderboard);
				yield return SendRequest(region, null, path, action_Result, ifModifiedSince, action_LastModified);
			}
...
namespace ZeShmouttsAssets.BlizzardAPI.JSON
{
	...
	/// </summary>
	[Serializable]
	public class Json_D3_SeasonLeaderboard : Object_JSON
	{
		// {{JSON_START}}
