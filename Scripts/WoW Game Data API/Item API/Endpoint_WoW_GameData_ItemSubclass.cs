...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			internal const string API_PATH_ITEMSUBCLASS = BASEPATH_WOW_GAMEDATA + "/item-class/{0}/item-subclass/{1}";
			...
			/// <returns></returns>
			public static IEnumerator GetItemSubclass(int itemClassId, int itemSubclassId, Action<Json_Wow_ItemSubclass> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
