...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			internal const string API_PATH_CREATURETYPESINDEX = BASEPATH_WOW_GAMEDATA + "/creature-type/index";
			...
			/// <returns></returns>
			public static IEnumerator GetCreatureTypesIndex(Action<Json_Wow_CreatureTypesIndex> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
...
namespace ZeShmouttsAssets.BlizzardAPI.JSON
{
	...
	public class Json_Wow_CreatureTypesIndex : Object_JSON
	{
		...
		public KeyNameIdStruct[] creature_types;
		// {{JSON_END}}
	}
}