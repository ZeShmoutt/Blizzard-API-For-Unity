...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			internal const string API_PATH_CREATUREFAMILYMEDIA = BASEPATH_WOW_GAMEDATA + "/media/creature-family/{0}";
			...
			/// <returns></returns>
			public static IEnumerator GetCreatureFamilyMedia(int creatureFamilyId, Action<Json_Wow_CreatureFamilyMedia> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
