...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			internal const string apiPath_AchievementCategory = BASEPATH_WOW_GAMEDATA + "/achievement-category/{0}";
			...
			/// <returns></returns>
			public static IEnumerator GetAchievementCategory(int achievementCategoryId, Action<Json_Wow_AchievementCategory> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DEFAULT_REGION)
			{
				string path = string.Format(apiPath_AchievementCategory, achievementCategoryId);
			...
			/// <param name="region">The region of the data to retrieve.</param>
			/// <returns></returns>
			public static IEnumerator GetAchievementCategoryRaw(int achievementCategoryId, Action<string> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DEFAULT_REGION)
			{
				string path = string.Format(apiPath_AchievementCategory, achievementCategoryId);
				yield return SendRequest(region, NAMESPACE_STATIC, path, action_Result, ifModifiedSince, action_LastModified);
			}
