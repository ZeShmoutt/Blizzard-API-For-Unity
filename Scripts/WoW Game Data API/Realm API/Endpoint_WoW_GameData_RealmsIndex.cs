...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetRealmsIndex(Action<Json_Wow_RealmsIndex> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
...
{
	/// <summary>
	/// JSON structure for World of Warcraft, representing an index of realms.
	/// </summary>
	[Serializable]
	public class Json_Wow_RealmsIndex : Object_JSON
	{
		// {{JSON_START}}
