...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class WowGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetRealmsIndex(Action<Json_Wow_RealmsIndex> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DEFAULT_REGION)
			{
