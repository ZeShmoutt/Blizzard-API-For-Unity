...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		{
			internal const string API_PATH_MYTHICKEYSTONEAFFIXMEDIA = BASEPATH_WOW_GAMEDATA + "/media/keystone-affix/{0}";
			...
			/// <returns></returns>
			public static IEnumerator GetMythicKeystoneAffixMedia(int keystoneAffixId, Action<Json_Wow_MythicKeystoneAffixMedia> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
