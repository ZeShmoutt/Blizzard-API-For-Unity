...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class HearthstoneGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator GetMetadataSets(Action<Json_Hearthstone_Metadata_Set[]> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DefaultRegion)
			{
			...
			/// <param name="region">The region of the data to retrieve.</param>
			/// <returns></returns>
			public static IEnumerator GetMetadataSetsRaw(Action<string> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, BattleNetRegion region = DefaultRegion)
			{
...
{
	/// <summary>
	/// JSON structure for Hearthstone, representing set metadata.
	/// </summary>
	[Serializable]
