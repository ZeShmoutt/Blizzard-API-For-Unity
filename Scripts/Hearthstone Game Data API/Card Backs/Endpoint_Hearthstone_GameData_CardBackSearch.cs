...
namespace ZeShmouttsAssets.BlizzardAPI
{
	...
	public static partial class BlizzardAPI
	{
		...
		public static partial class HearthstoneGameData
		{
			...
			/// <returns></returns>
			public static IEnumerator CardBackSearch(HearthstoneCardBackSearch searchParameters, Action<Json_Hearthstone_CardBacksList> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
			...
			/// <param name="region">The region of the data to retrieve.</param>
			/// <returns></returns>
			public static IEnumerator CardBackSearchRaw(HearthstoneCardBackSearch searchParameters, Action<string> action_Result, string ifModifiedSince = null, Action<string> action_LastModified = null, Action<string> action_OnError = null, BattleNetRegion region = DEFAULT_REGION)
			{
				string url = string.Concat(UrlDomain(region), apiPath_CardBackSearch, searchParameters != null ? searchParameters.ToURLParameters() : string.Empty);
				yield return CustomRequest(url, null, action_Result, ifModifiedSince, action_LastModified, action_OnError);
			}
